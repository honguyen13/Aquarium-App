...
const CrustaceanDetail = ({modalVisible, setModalVisible, data}) => {
  return (
    <Block>
        <Block row center style={{paddingHorizontal: theme.sizes.base}}>
        <TouchableOpacity
  ...
  return (
    <TouchableOpacity
      ...
      <Block shadow card row style={{backgroundColor: theme.colors.white}}>
        <Block flex={0.8}>
          <Image source={data.img[0]} resizeMode="stretch" style={styles.img} />
        </Block>
        <Block>
